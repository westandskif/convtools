...
def reducers_in_out():
    ...
    dict(
        groupby=c.item("name"),
        reduce=c.ReduceFuncs.FirstN(2, c.item("debit")),
        data=reducer_data1 + reducer_data2,
        output=[("Bill", [100, 50]), ("Nick", [1, 2])],
        raises=None,
    ),
    dict(
        groupby=c.item("name"),
        reduce=c.ReduceFuncs.FirstN(2, c.item("debit"), where=c.and_(c.item("debit").is_not(None), c.item("debit") < 100),),
        data=reducer_data1 + reducer_data2,
        output=[("Bill", [50]), ("Nick", [1, 2])],
        raises=None,
    ),
    dict(
        groupby=c.item("name"),
        reduce=c.ReduceFuncs.LastN(2, c.item("debit")),
        data=reducer_data1 + reducer_data2,
        output=[("Bill", [50, None]), ("Nick", [1, 2])],
        raises=None,
    ),
    dict(
        groupby=c.item("name"),
        reduce=c.ReduceFuncs.LastN(2, c.item("debit"), where=c.item("debit").is_not(None)),
        data=reducer_data1 + reducer_data2,
        output=[("Bill", [100, 50]), ("Nick", [1, 2])],
        raises=None,
    ),
    ...
    dict(
        groupby=True,
        reduce=c.ReduceFuncs.DictFirstN(2, c.item("name"), c.item("debit")),
        data=reducer_data1 + reducer_data2 + reducer_data3,
        output=[(True, {'Bill': [100, 50], 'Nick': [1, 2]})],
        raises=None,
    ),
    dict(
        groupby=True,
        reduce=c.ReduceFuncs.DictFirstN(2, c.item("name"), c.item("debit"), where=c.item("debit").is_not(None)),
        data=reducer_data1 + reducer_data2 + reducer_data3,
        output=[(True, {'Bill': [100, 50], 'Nick': [1, 2]})],
        raises=None,
    ),
    dict(
        groupby=True,
        reduce=c.ReduceFuncs.DictLastN(2, c.item("name"), c.item("debit")),
        data=reducer_data1 + reducer_data2 + reducer_data3,
        output=[(True, {'Bill': [None, 50], 'Nick': [2, 2]})],
        raises=None,
    ),
    dict(
        groupby=True,
        reduce=c.ReduceFuncs.DictLastN(2, c.item("name"), c.item("debit"), where=c.item("debit").is_not(None)),
        data=reducer_data1 + reducer_data2 + reducer_data3,
        output=[(True, {'Bill': [50, 50], 'Nick': [2, 2]})],
        raises=None,
    ),
